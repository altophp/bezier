...
| --- | ---: | ---: | --- |
| [Quadratic](curves/quadratic.md) | 2 | 3 | Simple arcs with one control handle; SVG `Q` segments |
| [Cubic](curves/cubic.md) | 3 | 4 | Independent start and end handles; SVG `C` segments |
| [Quartic](curves/quartic.md) | 4 | 5 | Existing degree-four data that must remain exact |
| [Quintic](curves/quintic.md) | 5 | 6 | Existing degree-five data that must remain exact |
| [N-order](curves/n-order.md) | Any degree from 1 | 2 or more | A control-point count determined at runtime |
